...
#define MESSAGE_BOX_TOP_OFFSET (8)
...
#define DEFAULT_POP_UP_MESSAGE "MOFO"
#define DEFAULT_CONFIRM_BUTTON_TEXT "Confirm"
#define DEFAULT_CANCEL_BUTTON_TEXT "Cancel"
#define DEFAULT_COMBO_BOX_VALUE "----------"
#define MIN_MSESSAGE_BOX_WIDTH (35)
#define MESSAGE_BOX_HEIGHT (10) 
#define MESSAGE_BOX_LEFT_OFFSET (17)	// 0.5*MIN_BOX_MESSAGE_WIDTH
